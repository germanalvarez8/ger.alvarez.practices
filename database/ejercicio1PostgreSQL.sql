drop schema if exists ejercicio1anio2020 cascade;
CREATE schema ejercicio1anio2020;



DROP TABLE IF EXISTS  ejercicio1anio2020.producto ;
CREATE TABLE  ejercicio1anio2020.producto  (
...
--
-- Dumping data for table  ejercicio1anio2020 . producto 
--

/*!40000 ALTER TABLE  producto  DISABLE KEYS */;
INSERT INTO  ejercicio1anio2020.producto  ( COD_PRODUCTO , DESCRIPCION , PRECIO ) VALUES 
...
--
-- Table structure for table  ejercicio1anio2020 . cliente 
--

CREATE TABLE ejercicio1anio2020.cliente (
...
--
-- Dumping data for table  ejercicio1anio2020 . cliente 
--

INSERT INTO  ejercicio1anio2020.cliente  ( NRO_CLIENTE , APELLIDO , NOMBRE , DIRECCION , TELEFONO ) VALUES
...
--
-- Table structure for table  ejercicio1anio2020 . factura 
--

DROP TABLE IF EXISTS  ejercicio1anio2020.factura ;
CREATE TABLE  ejercicio1anio2020.factura  (
   NRO_FACTURA  varchar(12) NOT NULL,
   FECHA  date NOT NULL,
   NRO_CLIENTE  int NOT NULL,
   MONTO  decimal(9,2) default NULL,
  PRIMARY KEY  ( NRO_FACTURA ),
  CONSTRAINT  FK_FACTURA_1  FOREIGN KEY ( NRO_CLIENTE ) REFERENCES  ejercicio1anio2020.cliente  ( NRO_CLIENTE )
); 

--
-- Dumping data for table  ejercicio1anio2020 . factura 
--

/*!40000 ALTER TABLE  factura  DISABLE KEYS */;
INSERT INTO  ejercicio1anio2020.factura  ( NRO_FACTURA , FECHA , NRO_CLIENTE , MONTO ) VALUES 
...
--
-- Table structure for table  ejercicio1anio2020 . itemfactura 
--

DROP TABLE IF EXISTS  ejercicio1anio2020.itemfactura ;
CREATE TABLE  ejercicio1anio2020.itemfactura  (
   NRO_FACTURA  varchar(12) NOT NULL,
   COD_PRODUCTO  int NOT NULL,
   CANTIDAD  int NOT NULL,
   PRECIO  decimal(9,2) NOT NULL,
  PRIMARY KEY  ( NRO_FACTURA , COD_PRODUCTO ),
  CONSTRAINT  FK_ITEMFACTURA_1  FOREIGN KEY ( COD_PRODUCTO ) REFERENCES  ejercicio1anio2020.producto  ( COD_PRODUCTO ),
  CONSTRAINT  FK_ITEMFACTURA_2  FOREIGN KEY ( NRO_FACTURA ) REFERENCES  ejercicio1anio2020.factura  ( NRO_FACTURA )
);

--
-- Dumping data for table  ejercicio1anio2020 . itemfactura 
--

/*!40000 ALTER TABLE  itemfactura  DISABLE KEYS */;
INSERT INTO  ejercicio1anio2020.itemfactura  ( NRO_FACTURA , COD_PRODUCTO , CANTIDAD , PRECIO ) VALUES 
...
--
-- Table structure for table  ejercicio1anio2020 . producto
--
