DROP schema IF EXISTS ejercicio3anio2020 cascade;
CREATE schema ejercicio3anio2020;

DROP TABLE IF EXISTS ejercicio3anio2020.alumno;
CREATE TABLE ejercicio3anio2020.alumno (
...
DROP TABLE IF EXISTS ejercicio3anio2020.taller;
CREATE TABLE ejercicio3anio2020.taller (
...
DROP TABLE IF EXISTS ejercicio3anio2020.realiza;
CREATE TABLE ejercicio3anio2020.realiza (
  nro_alumno integer NOT NULL ,
  codigo_taller integer NOT NULL ,
  PRIMARY KEY (nro_alumno,codigo_taller),
  constraint fk_realiza_nro_alumno
    foreign key (nro_alumno)
    REFERENCES ejercicio3anio2020.alumno (nro_alumno),
  constraint fk_realiza_codigo_taller
    foreign key (codigo_taller) 
    REFERENCES ejercicio3anio2020.taller 
);

INSERT INTO ejercicio3anio2020.alumno VALUES
...
INSERT INTO ejercicio3anio2020.taller VALUES
 (1, 'Cocina', 28),
...
INSERT INTO ejercicio3anio2020.realiza VALUES
 (1,1),
 (1,2),
 (1,5),
 (2,2),
