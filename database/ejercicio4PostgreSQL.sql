...
drop schema if exists ejercicio4anio2020 cascade;
CREATE schema ejercicio4anio2020;

DROP TABLE IF EXISTS ejercicio4anio2020.deporte;
CREATE TABLE ejercicio4anio2020.deporte (
  cod_deporte integer NOT NULL ,
  denominacion varchar(45) NOT NULL default '',
  PRIMARY KEY  (cod_deporte)
);

DROP TABLE IF EXISTS ejercicio4anio2020.competidor;
CREATE TABLE ejercicio4anio2020.competidor (
...
DROP TABLE IF EXISTS ejercicio4anio2020.medalla;
CREATE TABLE ejercicio4anio2020.medalla (
...
DROP TABLE IF EXISTS ejercicio4anio2020.competicion;
CREATE TABLE ejercicio4anio2020.competicion (
  pais varchar(25) NOT NULL default '',
  cod_deporte integer NOT NULL ,
  anio integer NOT NULL ,
...
INSERT INTO ejercicio4anio2020.deporte VALUES
 (1,'SALTO EN LARGO'),
 (2,'SALTO EN ALTO'),
 (3,'CARRERA 100 MTS'),
 (4,'CARRERA 200 MTS'),
...
INSERT INTO ejercicio4anio2020.competidor VALUES
...
INSERT INTO ejercicio4anio2020.competicion VALUES
 ('ARGENTINA',1,2000),
 ('ARGENTINA',2,2000),
 ('ARGENTINA',6,2003),
 ('BRASIL',5,2001),
...
INSERT INTO ejercicio4anio2020.medalla VALUES
